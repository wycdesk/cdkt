...
<div class="panel-wrap">
	...
	<form action="<%=request.getContextPath()%>/role/update/${role.id}" method="post" id="roleForm">
		<div class="field t-col">
			<h4>角色名称</h4>
			<div class="t-col-content mb20"><input type="text" value="${role.name}" id="roleName" readonly="readonly"></div>
		</div>
		<div class="field t-col">
			<h4>角色描述</h4>
...
$("#formSubmit").click(function () {
	...
	$.post("<%=request.getContextPath()%>/role/updateAndAssign/${role.id}/" + permissionIds, {description: description, name: '${role.name}'}, updateCallBack, 'json');
});
