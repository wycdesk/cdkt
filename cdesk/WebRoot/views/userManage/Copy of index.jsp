    ...
    <div class="left-content">
        <c:if test="${hasGroup1}">
            <div class="left-content-panel">
                <div class="left-content-panel-header">用户 <a data-toggle="modal" data-target="#addUserModal">+用户</a> <a data-toggle="modal" onClick="goImport();">批量导入</a></div>
...
<script id="table-tr-template" type="text/x-handlebars-template">
    <tr id="userFieldRows">
        ...
        {{#if telPhone}} 
        <a class="fa fa-phone" onclick="callout('{{telPhone}}')"></a>
        {{/if}} 
        </td>
    ...
    var getTableData = (function(){
        ...
        var pager = new cri.Pager($("#pagination"),{
            ...
            onPage:function(page,pageSize){
                ...
                getTableData({page:page,rows:pageSize,entId:'${entId}',userStatus:userStatus},url);
            }
        });
