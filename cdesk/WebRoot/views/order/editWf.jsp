                        ...
                        <form>
                            <fieldset>
                                <div class="form-group">
                                    <label for="serviceGroupId" class="control-label">受理客服组</label>
                                    <div>
                                ...
                                <div class="form-group">
                                    <label for="customServiceId" class="control-label">受理客服</label>
                                    <div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <select id="typeId" data-field="type" class="form-control">
                                            <option value = "nochange">-不改变-</option>
                                            <option value="">-</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <select id="priorityId"  data-field="priority" class="form-control">
                                            <option value = "nochange">-不改变-</option>
                                            <option value="">-</option>
	...
	$.ajax({
        ...
        success:function(data){
        	if(data.success){
            	...
            	$("#typeId").empty().append("<option value = 'nochange'>-不改变-</option>"
                        +"<option value = ''>-</option>"
                        +"<option value='1'>问题</option>"
                        +"<option value='2'>事务</option>"
                        +"<option value='3'>故障</option>"
            	...
            	$("#priorityId").empty().append("<option value = 'nochange'>-不改变-</option>"
                        +"<option value=''>-</option>"
                        +"<option value='1'>低</option>"
                        +"<option value='2'>中</option>"
                        +"<option value='3'>高</option>"
                ...
                getTableData({condition:cond,page:1,rows:10,refresh:-1});
            }else{
