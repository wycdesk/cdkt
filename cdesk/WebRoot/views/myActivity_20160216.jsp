            ...
            <div class="user-nav">
                ...
                <div class="dropdown profile-element" style="padding:0px;">
                    ...
                    <ul class="dropdown-menu animated fadeInRight m-t-xs">
                        ...
                        <li><a class="J_menuItem" href="<%=request.getContextPath()%>/">返回前台页面</a>
                        </li>
        ...
        <div class="wrap user-center">
            ...
            <nav class="user-center-nav" style="z-index: 888;">
                <ul id="userCenterNavList">
                    <li><a class="active" data-link="#activity-main1">我的消息</a></li>
                    <li><a data-link="#activity-main2" onclick="queryAllData()">我的提问</a></li>
                    <li><a data-link="#activity-main3">我的发表</a></li>
                    <li><a data-link="#activity-main4">我的关注</a></li>
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane active" id="information">
                            <form class="user-setting-form"  onsubmit="informationSubmit();return false;" method="post" >
                                ...
                                <div class="user-setting-form-item">
                                    <label>描述：</label>
                                    <textarea name="userDesc" id="userDesc" data-autosize-on="true" style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 80px;"></textarea>
                                </div>
                        ...
                        <div role="tabpanel" class="tab-pane" id="password">
                            <form class="user-setting-form" onsubmit="passwordSubmit();return false;" method="post">
                                ...
                                <div class="user-setting-form-item">
                                    <label>新密码：</label>
                                    <input name="newpassword" type="password" id="newLoginPwd" maxlength="100" />
                                </div>
                                <div class="user-setting-form-item">
                                    <div>
                                        <!-- weak,medium,strong -->
