package com.channelsoft.ems.iosapi.util;
...
public class IosSignKeyUtils {
	...
	public static boolean validate(String signKey){
		...
		try{
			 ...
			 if(!k[1].equals(WebappConfigUtil.getParameter("IOS_SKEY"))) return false;
			 return true;
		}
		catch(Exception e){
			e.printStackTrace();
	...
	public static String getSignKey(String key){
		...
		String sk=CdeskEncrptDes.encryptST(key+"_"+WebappConfigUtil.getParameter("IOS_SKEY")+"_"+str);
		return sk;
	}
}
