  ...
  <div class="panel-wrap">  
   <form target="_self" method="post" id="fieldForm">
     ...
     <ul class="breadcrumbs">
         <li>
         <a target="_self" href="<%=request.getContextPath()%>/commHistoryField/commHistoryfields">联络历史字段</a>
         </li>
         <li>添加联络历史字段 : <span id="span1"></span></li>
     </ul>   
...
/* 		   匹配格式：11位手机号
	  ...
	  $("#submitbutton").attr("disabled","disabled");
          $.ajax({
              url: "<%=request.getContextPath()%>/commHistoryField/addDefinedField",
              dataType: 'json',
