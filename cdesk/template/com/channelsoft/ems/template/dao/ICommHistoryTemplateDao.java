...
public interface ICommHistoryTemplateDao {
	...
	/* 删除模板（逻辑删除） */
	public int deleteTemplate(String entId, String key)
			throws DataAccessException;
	...
	/* 排序所有启用的模板 */
	public int sortTemplate(String entId, String[] sortKey, int[] sortNums)
			throws DataAccessException;

	/* 添加工单默认字段 */
	public void addDefaultField(List<BaseFieldPo> list, String entId)
			throws DataAccessException;
	...
	public List<BaseFieldPo> queryFields(String entId, BaseFieldPo po,
			PageInfo page) throws DataAccessException;
	...
	* @throws DataAccessException
	*/
	public int addDefaultTemp(TemplatePo po, String entId)
			throws DataAccessException;
}
