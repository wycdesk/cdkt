...
public class CommHistoryTemplateDaoImpl extends BaseMongoTemplate  implements ICommHistoryTemplateDao {
	...
	public int addTemp(TemplatePo po, String entId) throws DataAccessException {
		...
		dbo.put("tempType", TemplateTypeEnum.COMMHISTORY.value);
